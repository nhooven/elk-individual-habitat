...
elk.data <- read.csv("AW_sampled.csv")
...
write.csv(coefs.df.melt, "randomslopes_AW_plot.csv")

# write rndom slopes file for analysis
coefs.df$Season <- "AW"

write.csv(coefs.df, "randomslopes_AW_analysis.csv")

#_____________________________________________________________________________________________________________
# 8. Save image for predictions ----
#_____________________________________________________________________________________________________________

save.image(file = "AW_models.RData")
