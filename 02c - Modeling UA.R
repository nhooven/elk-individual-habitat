...
elk.data <- read.csv("UA_sampled.csv")
...
write.csv(coefs.df.melt, "randomslopes_UA_plot.csv")

# write rndom slopes file for analysis
coefs.df$Season <- "UA"

write.csv(coefs.df, "randomslopes_UA_analysis.csv")

#_____________________________________________________________________________________________________________
# 8. Save image for predictions ----
#_____________________________________________________________________________________________________________

save.image(file = "UA_models.RData")
